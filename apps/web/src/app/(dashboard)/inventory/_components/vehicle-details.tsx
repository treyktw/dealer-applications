// src/app/(dashboard)/inventory/_components/tabs/VehicleDetailsTab.tsx
"use client";
...
export default function VehicleDetailsTab({ form }: VehicleDetailsTabProps) {
  return (
    <>
      <CardHeader>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="e.g., ST10025" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
